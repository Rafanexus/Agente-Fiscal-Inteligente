...
1.  **Estrutura da Resposta Final:** Ao formular a resposta para o usuário, apresente primeiro o resultado direto e, em seguida, uma breve explicação de como você chegou a ele. Mantenha a explicação clara e use formatação de markdown (negrito, listas) para facilitar a leitura, evite qualquer formatação que possa quebrar o texto.  
